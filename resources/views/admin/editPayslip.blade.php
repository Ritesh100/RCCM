    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><strong>Gross Earning:</strong> {{ $currency }} {{ number_format($gross_earning, 2) }}</li>
                <li class="list-group-item"><strong>Annual Leave:</strong> {{ number_format($annual_leave, 2) }} hrs</li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="viewTimesheetForm" action="{{ route('admin.updatePayslip', $timesheet->id) }}" method="POST">
                    @csrf
                    @method('PUT')
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function calculateWorkTime() {
            ...
            if (startTime && closeTime) {
                ...
                document.getElementById('viewWorkTime').value = workTime.toFixed(2) + ' hours';
            }
        }
